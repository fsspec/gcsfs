...
class TestExtendedGcsFileSystemLsIntegration:
    ...
    def test_hns_ls_edge_cases(self, gcs_hns):
        ...
        try:
            ...
            assert (
                path_parent_empty in items_root_cleaned
            ), f"Parent of empty subfolder '{path_parent_empty}' missing from root listing"
            assert (
                path_parent_file in items_root_cleaned
            ...
            assert (
                path_nested_empty in items_nested_cleaned
            ...
            items_file_parent_cleaned = [item.rstrip("/") for item in items_file_parent]
            expected_sub_folder = f"{path_parent_file}/sub_file"
            assert (
                expected_sub_folder in items_file_parent_cleaned
