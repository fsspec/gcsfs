...
- **Averaging**: Takes the average of 3 consecutive runs for both PR and base branches to eliminate network jitter.
- **Threshold**: Flags performance regressions exceeding **10%** in the report.
