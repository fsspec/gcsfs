...
| | `rust_http` | 480.0 GiB | 101.23s | **4,855.32 MB/s** | **40.73 Gbps** | 9,849.7 MB | 819.4% (8.2 cores) | 1.73 |
...
| | `rust_grpc (48 ch)` | 160.0 GiB | 19.62s | **8,349.14 MB/s** | **70.04 Gbps** | 12,349.4 MB | 771.8 MB | 4,109.1% | 5.04 |
